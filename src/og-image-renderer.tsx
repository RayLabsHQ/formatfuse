...
function getToolTheme(toolType: string): { primary: string; secondary: string } {
...
export async function toolOGImage({ 
  ...
  } else if (displayTitle.includes('Converter') || displayTitle.includes('Generator')) {
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              {features.map((feature, index) => (
                <div key={index} style={{
                  ...
                  <svg style={{ width: 24, height: 24 }} fill="none" stroke={index === 0 ? theme.primary : index === 1 ? theme.secondary : theme.primary} viewBox="0 0 24 24">
                    {index === 0 && <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />}
                    {index === 1 && <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />}
            ...
            <p style={{
              ...
              {description || 'Transform your files with powerful tools. Fast, secure, and completely free - right in your browser.'}
            </p>
          </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  {sourceFormat && targetFormat ? `${sourceFormat.toUpperCase()} → ${targetFormat.toUpperCase()}` : 'Fast & Secure'}
                </span>
              </div>
            </div>
          </div>
