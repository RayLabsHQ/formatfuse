  ...
  return (
    <div className="min-h-screen w-full">
      ...
      <div className="hidden sm:block fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/2 left-1/3 w-80 h-80 bg-accent/5 rounded-full blur-3xl animate-blob animation-delay-4000" />
      </div>

      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:py-6 py-6 sm:py-12 relative z-10">
        {/* Header */}
        <ToolHeader
        ...
        <div className="space-y-6">
          ...
          <div className="hidden sm:grid grid-cols-1 gap-6">
            {/* Input Panel */}
            <div className="bg-card/50 backdrop-blur-sm rounded-2xl border border-border/50 p-6 sm:p-8 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
              <div className="space-y-6">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <h3 className="text-lg font-semibold">JWT Token</h3>
                    <p className="text-sm text-muted-foreground mt-1">Paste your JWT token below to decode and inspect its contents</p>
                  </div>
                  <div className="flex gap-2">
                    <Button variant="ghost" size="sm" onClick={handlePaste} className="h-9">
                      <ClipboardPaste className="w-4 h-4" />
                      <span className="ml-2 hidden sm:inline">Paste</span>
                    </Button>
                ...
                <div className="relative">
                  <textarea
                    ...
                    placeholder="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMiwiZXhwIjoxOTUxNjIzOTAyMn0.4Adcj3UFYzPUVaVF43FmMab3EguRlv9zZJPjSyVHG4I"
                    className="w-full h-32 px-4 py-3 bg-background/50 border border-border rounded-lg resize-none font-mono text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-200 placeholder:text-muted-foreground/50"
                    style={{ wordBreak: 'break-all', overflowWrap: 'anywhere' }}
                  />
                  {jwt && (
                    <div className="absolute bottom-3 right-1 text-xs text-muted-foreground bg-background/80 px-2 py-1 rounded">
                      {jwt.length} chars
                    </div>
                  )}
                </div>
            ...
            {/* Output Panel */}
            <div className="bg-card/50 backdrop-blur-sm rounded-2xl border border-border/50 p-4 sm:p-6 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
              <div className="h-full flex flex-col">
                <h3 className="text-lg font-semibold mb-4">Decoded Output</h3>
          ...
          <div className="sm:hidden">
            {activeTab === "input" && (
              <div className="bg-card/50 backdrop-blur-sm rounded-2xl border border-border/50 p-4 animate-fade-in-up">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-semibold">JWT Token</h3>
                    <div className="flex gap-1">
                      <Button variant="ghost" size="sm" onClick={handlePaste} className="h-8 px-2">
                        <ClipboardPaste className="w-4 h-4" />
                      </Button>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className="w-full h-32 px-3 py-2 bg-background/50 border border-border rounded-lg resize-none font-mono text-xs focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-200 placeholder:text-muted-foreground/50"
                      style={{ wordBreak: 'break-all', overflowWrap: 'anywhere' }}
                    />
                    {jwt && (
                      <div className="absolute bottom-3 right-1.5 text-xs text-muted-foreground bg-background/80 px-1.5 py-0.5 rounded text-[10px]">
                        {jwt.length}
                      </div>
                    )}
                  </div>
              ...
              <div className="bg-card/50 backdrop-blur-sm rounded-2xl border border-border/50 p-4 animate-fade-in-up">
                ...
                <div className="overflow-y-auto">
                  {decoded ? (
                    decoded.isValid ? (
                      <div className="space-y-4">
                        {/* Copy the same output content from desktop */}
                        {/* Expiration Status */}
                        {expirationStatus && (
                          <div
                            className={cn(
