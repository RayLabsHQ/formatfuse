...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      "This tool supports 7Z, RAR, ZIP, TAR, GZIP, BZIP2, XZ, and many other archive formats thanks to libarchive.js.",
  },
  {
    question: "Is it safe to extract RAR files?",
    answer:
  ...
  },
  {
    ...
    answer:
      "The tool can handle archives up to 2GB, limited by browser memory. For larger files, consider using desktop software.",
  },
  {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 tracking-tight animate-fade-in-up">
            ...
            <span className="text-primary">Archive Extractor</span>
          </h1>
          ...
          >
            Extract ZIP, 7Z, RAR, TAR, and many other archive formats
        ...
        <div className="space-y-6">
          <input
            ...
            accept=".7z,.rar,.zip,.tar,.gz,.bz2,.xz,.iso,.tar.gz,.tar.bz2"
            className="hidden"
          />
              ...
              >
                <div className="p-8 sm:p-12 text-center pointer-events-none">
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    Supports 7Z, RAR, ZIP, TAR, and many more formats
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-6 mt-12">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="bg-card/50 backdrop-blur-sm rounded-xl p-6 border border-border/50">
              <h3 className="font-semibold mb-2">Archive Formats</h3>
              <p className="text-sm text-muted-foreground">
                7Z, ZIP, RAR, TAR, GZ, BZ2, XZ, ISO, CAB, AR, CPIO, LZMA
              </p>
            </div>
            <div className="bg-card/50 backdrop-blur-sm rounded-xl p-6 border border-border/50">
              <h3 className="font-semibold mb-2">Compression</h3>
              <p className="text-sm text-muted-foreground">
                GZIP, BZIP2, XZ, LZMA, LZ4, ZSTD, and more
              </p>
            </div>
            <div className="bg-card/50 backdrop-blur-sm rounded-xl p-6 border border-border/50">
              <h3 className="font-semibold mb-2">Special Support</h3>
              <p className="text-sm text-muted-foreground">
                Multi-volume archives, solid archives, SFX archives
              </p>
            </div>
          </div>
        </div>
