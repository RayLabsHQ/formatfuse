...
export default function PasswordGenerator() {
  ...
  return (
    <div className="w-full flex flex-col flex-1 min-h-0">
      {/* Security-themed Gradient Effects - Hidden on mobile */}
      <div className="hidden sm:block fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-br from-primary/[0.01] via-transparent to-accent/[0.01]" />
        <div className="absolute top-1/3 right-10 w-80 h-80 bg-primary/12 rounded-full blur-3xl animate-blob" />
        <div className="absolute bottom-20 left-1/3 w-64 h-64 bg-accent/8 rounded-full blur-3xl" />
        <div className="absolute top-10 left-10 w-72 h-72 bg-primary/5 rounded-full blur-3xl animate-blob animation-delay-4000" />
      </div>
