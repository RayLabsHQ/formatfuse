...
export default function PasswordGenerator() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto p-4 sm:p-6 space-y-8">
      ...
      <Tabs
        value={mode}
        onValueChange={(value) => setMode(value as "random" | "memorable")}
        className="w-full"
      >
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          ...
          <p>
            • Longer passwords are generally stronger. Aim for 16+ characters
            for random or 4+ words for memorable.
          </p>
          <p>
            • Combine uppercase, lowercase, numbers, and symbols for random
            passwords.
          </p>
          <p>
            • All generation happens securely in your browser. No data is sent
            to any server.
          </p>
        </CardContent>
      </Card>
