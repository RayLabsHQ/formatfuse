  ...
  if (isMobile) {
    return (
      <MobileToolLayout>
        ...
        <MobileTabs
          value={mobileTab}
          onValueChange={(v) => setMobileTab(v as "input" | "results")}
          defaultValue="input"
        >
                ...
                <TabsContent value="text" className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) => {
                      ...
                      if (activeTab === "text") setFile(null);
                      setFileName("");
                      setFileSize("");
                    }}
              ...
              {results.length > 0 ? (
                        ...
                        {isExpanded && (
                          <div className="px-4 pb-4 space-y-3 border-t">
                            <div className="flex items-center justify-between">
                              <p className="text-xs text-muted-foreground">
                                {hashType.bits}-bit • {result.timeMs.toFixed(2)}
                                ms
                              </p>
                              {canCopy && (
                                <ActionIconButton
                                  onClick={() =>
                                    copyToClipboard(result.hash, hashType.name)
                                  }
                                  icon={
                                    copiedHash ===
                                    `${hashType.name}-${result.hash}` ? (
                                      <Check />
                                    ) : (
                                      <Copy />
                                    )
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    Go to Input tab to generate hashes
                  </p>
                </div>
              )}
            </MobileToolContent>
          ...
          <div className="space-y-4 text-sm">
            <div>
              ...
              <ul className="space-y-1 text-muted-foreground">
                ...
                <li>
                  • MD5 and SHA-1 are legacy algorithms with vulnerabilities
                </li>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                All hashing is performed locally in your browser. No data is
                sent to any server.
              </p>
            </div>
          </div>
    ...
    <div className="w-full max-w-3xl mx-auto p-4 sm:p-6 space-y-8">
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-2">
              ...
              >
                <Key className="w-4 h-4 text-muted-foreground" /> Use HMAC
                (Keyed-Hash)
              </Label>
            </div>
            {useHmac && (
              <div className="space-y-1">
                ...
                />
                <p className="text-xs text-muted-foreground">
                  The secret key for HMAC. Keep this confidential.
                </p>
              </div>
            )}
          </div>
              ...
              <Card key={hashType.id}>
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    >
                      ...
                      {isLegacy && (
                        <Badge
                          variant="outline"
                          className="ml-2 text-xs border-amber-500/50 text-amber-600 dark:border-amber-600/50 dark:text-amber-500"
                        >
                          Legacy
                        </Badge>
                      )}
                  ...
                  <CardDescription className="text-xs">
                    {hashType.bits}-bit hash.{" "}
                    {result.timeMs > 0 &&
                      `Generated in ${result.timeMs.toFixed(2)}ms.`}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>
            • Cryptographic hash functions produce a fixed-size string (hash)
            from input data.
          </p>
          <p>
            • <strong>SHA-256</strong> and above are generally recommended for
            new applications.
          </p>
          <p>
            • <strong>MD5</strong> and <strong>SHA-1</strong> are considered
            insecure for many purposes due to collision vulnerabilities.
          </p>
          <p>
            • <strong>HMAC</strong> combines a hash function with a secret key
      ...
      <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
        ...
        <div className="p-3 sm:p-4 rounded-lg border">
          ...
          <p className="text-xs sm:text-sm text-muted-foreground">
            Generate keyed hashes (HMAC) for enhanced message integrity and
            authentication.
          </p>
        </div>
      </div>
