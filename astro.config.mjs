    ...
    server: {
      headers: {
        ...
        "Content-Security-Policy":
          "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://scripts.simpleanalyticscdn.com https://eu.i.posthog.com https://eu-assets.i.posthog.com https://*.posthog.com; connect-src 'self' https://queue.simpleanalyticscdn.com https://eu.i.posthog.com https://eu-assets.i.posthog.com https://*.posthog.com; img-src 'self' data: blob: https://queue.simpleanalyticscdn.com https://simpleanalyticsbadges.com https://eu.i.posthog.com https://eu-assets.i.posthog.com https://*.posthog.com; style-src 'self' 'unsafe-inline'; worker-src 'self' blob:; font-src 'self' https://fonts.gstatic.com; frame-src 'self';",
      },
    },
    build: {
      rollupOptions: {
