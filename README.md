...
- CSP reminder:
- Ensure `connect-src` allows `https://eu.i.posthog.com https://eu-assets.i.posthog.com https://*.posthog.com` and `https://cloud.umami.is https://api-gateway.umami.dev` if you use Umami Cloud.
