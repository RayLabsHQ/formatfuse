...
describe('Image Converter - Format Tests', () => {
  ...
  describe('PNG conversions', () => {
    ...
    beforeAll(() => {
      pngData = new Uint8Array(readFileSync(join(__dirname, 'fixtures/images/small.png')));
    });
  ...
  describe('JPEG conversions', () => {
    ...
    beforeAll(() => {
      jpegData = new Uint8Array(readFileSync(join(__dirname, 'fixtures/images/test.jpg')));
    });
    ...
    it('should convert JPEG to PNG', () => {
      const result = convertImage(jpegData, 'image/jpeg', 'image/png', () => {});
      expect(result).toBeInstanceOf(Uint8Array);
      // PNG signature
    ...
    it('should convert JPEG to WebP', () => {
      const result = convertImage(jpegData, 'image/jpeg', 'image/webp', () => {});
      expect(result).toBeInstanceOf(Uint8Array);
      expect(result.length).toBeGreaterThan(0);
    });
  });
  ...
  describe('WebP conversions', () => {
    ...
    beforeAll(() => {
      webpData = new Uint8Array(readFileSync(join(__dirname, 'fixtures/images/test.webp')));
    });
    ...
    it('should convert WebP to PNG', () => {
      const result = convertImage(webpData, 'image/webp', 'image/png', () => {});
      expect(result).toBeInstanceOf(Uint8Array);
      expect(result[0]).toBe(0x89); // PNG signature
    });

    it('should convert WebP to JPEG', () => {
      const result = convertImage(webpData, 'image/webp', 'image/jpeg', () => {});
      expect(result).toBeInstanceOf(Uint8Array);
  ...
  describe('GIF conversions', () => {
    ...
    beforeAll(() => {
      gifData = new Uint8Array(readFileSync(join(__dirname, 'fixtures/images/test.gif')));
    });
  ...
  describe('Transparent image handling', () => {
    ...
    beforeAll(() => {
      transparentPng = new Uint8Array(readFileSync(join(__dirname, 'fixtures/images/transparent.png')));
    });

    it('should preserve transparency when converting PNG to WebP', () => {
      const result = convertImage(transparentPng, 'image/png', 'image/webp', () => {});
      expect(result).toBeInstanceOf(Uint8Array);
      expect(result.length).toBeGreaterThan(0);
    });
  });
  ...
  describe('Different size handling', () => {
    it('should handle small images (100x100)', () => {
      const data = new Uint8Array(readFileSync(join(__dirname, 'fixtures/images/small.png')));
    ...
    it('should handle medium images (500x300)', () => {
      const data = new Uint8Array(readFileSync(join(__dirname, 'fixtures/images/medium.png')));
      const metadata = loadMetadata(data, 'image/png', () => {});
