...
const additionalFormats = [
  ...
  {
    url: "https://placehold.co/32x32/blue/white/png?text=ICO",
    file: "icon-32.png",
    note: "Will convert to ICO",
  },
  {
    url: "https://placehold.co/256x256/blue/white/png?text=ICO",
    file: "icon-256.png",
    note: "Max ICO size",
  },
  ...
  {
    url: "https://placehold.co/200x200/green/white/png?text=TIFF",
    file: "test-tiff-source.png",
    note: "For TIFF conversion",
  },

  // BMP format test source
  {
    url: "https://placehold.co/200x200/red/white/png?text=BMP",
    file: "test-bmp-source.png",
    note: "For BMP conversion",
  },

  // Different aspect ratios for testing
  {
    url: "https://placehold.co/400x200/purple/white/png?text=Wide",
    file: "wide.png",
    note: "Wide aspect ratio",
  },
  {
    url: "https://placehold.co/200x400/orange/white/png?text=Tall",
    file: "tall.png",
  ...
  // Edge cases
  {
    url: "https://placehold.co/10x10/black/white/png?text=.",
    file: "tiny.png",
    note: "Minimum size (10x10)",
  },
  {
    url: "https://placehold.co/1x1/red/red/png",
    file: "pixel.png",
    note: "Single pixel",
  },
];
...
function createTestFiles() {
  ...
  const tgaHeader = Buffer.from([
    0,
    0,
    2, // ID length, Color map type, Image type (uncompressed RGB)
    0,
    0,
    0,
    0,
    ...
    0, // Width (2), Height (2)
    24,
    0, // Pixel depth (24-bit), Image descriptor
  ]);
  const tgaPixels = Buffer.from([
    255,
    0,
    0, // Blue, Green, Red (TGA uses BGR order)
    0,
    255,
    0,
    0,
  ...
  console.log(
    "- QOI: Quite OK Image format - relatively new, need special tools to create",
  );
  ...
  console.log(
    "- DDS: DirectDraw Surface - decode only, primarily for game textures",
  );
